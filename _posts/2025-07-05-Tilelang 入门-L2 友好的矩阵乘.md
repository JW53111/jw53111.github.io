...
和 Tilelang 群友友好交流了[之前关于 L2 优化矩阵乘算法的疑问](https://wu-kan.cn/2024/11/22/Triton-%E5%85%A5%E9%97%A8-L2-%E5%8F%8B%E5%A5%BD%E7%9A%84%E7%9F%A9%E9%98%B5%E4%B9%98/)，本文基于 Tilelang 实现 matmul 算子，验证 L2 swizzle 算法。**或许是哪里写的有问题，现在的代码性能完全不及预期，且存在显存泄露情况。待和群友进一步请教。**
...
为了省事，图中的 `Tilelang_ps_-10` 代表不使用 L2 swizzle。从图上来看，这个算法并不总是最优的，实际使用的时候最好是把他加进搜索空间，而非当成即插即用的甜点优化。
